...
#Autonomous Program
    ...
    #using voodoo magic invented by Muhammad ibn Mūsā al-Khwārizmī in 9th century AD
    ...
    #we shall create a statement that calcualted velocity based off of how much we calculate each percent changed the mm distance by.
...
def autonomous_skills():
    #ryan - note to you plz use #'s to label all of these pls
